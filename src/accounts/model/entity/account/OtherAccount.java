...
@NamedQuery(name="OtherAccount.findAll",query="SELECT oth FROM OtherAccount oth WHERE oth.company=:comp")
public class OtherAccount {


	@Id
	@TableGenerator(name = "OtherAccount_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", allocationSize = 1)
	@GeneratedValue(strategy= GenerationType.TABLE, generator = "OtherAccount_GEN")
	private long id;
